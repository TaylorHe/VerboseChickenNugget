...
################## O(n^2) #####################
def amicable_even_faster(size = 100000):
    """
    ...
    amicables = []
    divisors = [0] * (size*10) # this part is bounded by some number, dunno what
    for a in range(1, size):
        for b in range(2, size/a):
            divisors[a*b] += a
    # print m
    # print max(divisors)
    # print divisors
